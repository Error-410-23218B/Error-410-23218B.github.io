...
function transformFile(file, pluginPasses) {
  var async, _iterator, _step, pluginPairs, passPairs, passes, visitors, _iterator2, _step2, _plugin2, _pass2, _i, _passPairs, _passPairs$_i, plugin, pass, fn, visitor, _i2, _passPairs2, _passPairs2$_i, _plugin, _pass, _fn;
  return _regeneratorRuntime().wrap(function transformFile$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 5:
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _pass2 = new _pluginPass["default"](file, _plugin2.key, _plugin2.options, async);
      ...
      case 13:
        ...
        fn = (0, _async.maybeAsync)(plugin.pre, "You appear to be using an async plugin/preset, but Babel has been called synchronously");
        return _context2.delegateYield(fn.call(pass, file), "t1", 18);
      case 18:
        _i++;
        _context2.next = 13;
        break;
      ...
      case 24:
        ...
        _fn = (0, _async.maybeAsync)(_plugin.post, "You appear to be using an async plugin/preset, but Babel has been called synchronously");
        return _context2.delegateYield(_fn.call(_pass, file), "t2", 29);
      case 29:
        _i2++;
        _context2.next = 24;
        break;
