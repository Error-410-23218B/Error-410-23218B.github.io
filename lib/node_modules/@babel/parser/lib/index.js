    ...
    return _createClass(FlowParserMixin, [{
      ...
      value: function parseFunctionBody(node, allowExpressionBody) {
        ...
        if (allowExpressionBody) {
          this.forwardNoArrowParamsConversionAt(node, function () {
            return _superPropGet(FlowParserMixin, "parseFunctionBody", _this13, 3)([node, true, isMethod]);
          });
          return;
        }
      ...
      value: function parseMaybeAssign(refExpressionErrors, afterLeftParse) {
        ...
        if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
          ...
          jsx = this.tryParse(function () {
            return _superPropGet(FlowParserMixin, "parseMaybeAssign", _this16, 3)([refExpressionErrors, afterLeftParse]);
          }, state);
        ...
        if ((_jsx = jsx) != null && _jsx.error || this.match(47)) {
          ...
          var arrow = this.tryParse(function (abort) {
            ...
            var arrowExpression = _this16.forwardNoArrowParamsConversionAt(typeParameters, function () {
              var result = _superPropGet(FlowParserMixin, "parseMaybeAssign", _this16, 3)([refExpressionErrors, afterLeftParse]);
      ...
      value: function parseSubscripts(base, startLoc, noCalls) {
        ...
        if (base.type === "Identifier" && base.name === "async" && this.state.noArrowAt.includes(startLoc.index)) {
          ...
          var result = this.tryParse(function () {
            return _superPropGet(FlowParserMixin, "parseSubscripts", _this18, 3)([base, startLoc, noCalls]);
          }, state);
      ...
      value: function parseSubscript(base, startLoc, noCalls, subscriptState) {
        ...
        if (this.match(18) && this.isLookaheadToken_lt()) {
          ...
          var result = this.tryParse(function () {
            ...
            _this19.expect(10);
            _node6.arguments = _superPropGet(FlowParserMixin, "parseCallExpressionArguments", _this19, 3)([11]);
...
var TSErrors = ParseErrorEnum(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["typescript"])))({
  ...
  InvalidModifierOnTypeMember: function InvalidModifierOnTypeMember(_ref73) {
    var modifier = _ref73.modifier;
    return "'".concat(modifier, "' modifier cannot appear on a type member.");
  },
  InvalidModifierOnTypeParameter: function InvalidModifierOnTypeParameter(_ref74) {
    var modifier = _ref74.modifier;
    return "'".concat(modifier, "' modifier cannot appear on a type parameter.");
  },
  InvalidModifierOnTypeParameterPositions: function InvalidModifierOnTypeParameterPositions(_ref75) {
  ...
  InvalidModifiersOrder: function InvalidModifiersOrder(_ref76) {
    var orderedModifiers = _ref76.orderedModifiers;
  ...
  PrivateElementHasAccessibility: function PrivateElementHasAccessibility(_ref77) {
  ...
  SingleTypeParameterWithoutTrailingComma: function SingleTypeParameterWithoutTrailingComma(_ref78) {
    var typeParameterName = _ref78.typeParameterName;
  ...
  UnsupportedSignatureParameterKind: function UnsupportedSignatureParameterKind(_ref79) {
...
var typescript = function typescript(superClass) {
  return /*#__PURE__*/function (_superClass4) {
    ...
    return _createClass(TypeScriptParserMixin, [{
      ...
      value: function tsParseModifiers(_ref80, modified) {
        var _this27 = this;
        var allowedModifiers = _ref80.allowedModifiers,
          disallowedModifiers = _ref80.disallowedModifiers,
          stopOnStartOfClassStaticBlock = _ref80.stopOnStartOfClassStaticBlock,
          _ref80$errorTemplate = _ref80.errorTemplate,
          errorTemplate = _ref80$errorTemplate === void 0 ? TSErrors.InvalidModifierOnTypeMember : _ref80$errorTemplate;
      ...
      value: function tsTryParseDeclare(nany) {
        ...
        return this.tsInAmbientContext(function () {
          switch (startType) {
            case 68:
              nany.declare = true;
              return _superPropGet(TypeScriptParserMixin, "parseFunctionStatement", _this41, 3)([nany, false, false]);
            case 80:
              nany.declare = true;
      ...
      value: function tsTryParseGenericAsyncArrowFunction(startLoc) {
        ...
        var res = this.tsTryParseAndCatch(function () {
          ...
          _superPropGet(TypeScriptParserMixin, "parseFunctionParams", _this42, 3)([node]);
        ...
        if (this.match(47) || this.match(51)) {
          ...
          var result = this.tsTryParseAndCatch(function () {
            ...
            if (tokenIsTemplate(_this45.state.type)) {
              var _result = _superPropGet(TypeScriptParserMixin, "parseTaggedTemplateExpression", _this45, 3)([base, startLoc, state]);
            ...
            if (!noCalls && _this45.eat(10)) {
              ...
              _node11.callee = base;
              _node11.arguments = _this45.parseCallExpressionArguments(11);
      ...
      value: function parseClassMember(classBody, member, state) {
        ...
        var callParseClassMemberWithIsStatic = function callParseClassMemberWithIsStatic() {
          if (_this47.tsIsStartOfStaticBlocks()) {
            ...
            _superPropGet(TypeScriptParserMixin, "parseClassStaticBlock", _this47, 3)([classBody, member]);
          } else {
      ...
      value: function parseConditional(expr, startLoc, refExpressionErrors) {
        ...
        var result = this.tryParse(function () {
          return _superPropGet(TypeScriptParserMixin, "parseConditional", _this48, 3)([expr, startLoc]);
        });
        if (!result.node) {
          if (result.error) {
            _superPropGet(TypeScriptParserMixin, "setOptionalParametersError", this, 3)([refExpressionErrors, result.error]);
          }
          return expr;
        }
        if (result.error) this.state = result.failState;
      ...
      value: function parseMaybeDecoratorArguments(expr) {
        if (this.match(47) || this.match(51)) {
          ...
          if (this.match(10)) {
            var call = _superPropGet(TypeScriptParserMixin, "parseMaybeDecoratorArguments", this, 3)([expr]);
            call.typeParameters = typeArguments;
            return call;
          }
          this.unexpected(null, 10);
        }
        return _superPropGet(TypeScriptParserMixin, "parseMaybeDecoratorArguments", this, 3)([expr]);
      }
    }, {
      key: "checkCommaAfterRest",
      value: function checkCommaAfterRest(close) {
      ...
      value: function toAssignableList(exprList, trailingCommaLoc, isLHS) {
        ...
        _superPropGet(TypeScriptParserMixin, "toAssignableList", this, 3)([exprList, trailingCommaLoc, isLHS]);
      }
    }, {
      key: "typeCastToParameter",
      value: function typeCastToParameter(node) {
...
function getOptions(opts) {
  ...
  for (var _i4 = 0, _Object$keys3 = Object.keys(options); _i4 < _Object$keys3.length; _i4++) {
  ...
  return _createClass(StatementParser, [{
    ...
    value: function isJSONModuleImport(node) {
      if (node.assertions != null) {
        return node.assertions.some(function (_ref81) {
          var key = _ref81.key,
            value = _ref81.value;
